<?php
	...
	if($_POST)
	{
		...
		{
			$msg[2] = "Preencha o preco do produto";
			$erro = true;
		}
		...
		if(!$erro)
		{
			...
			$produto = new Produto($_POST["idproduto"], $_POST["nome"], $_POST["descricao"], $_POST["preco"], 
			$imagem, $_POST["estoque"],$categoria);
			$produtoDAO = new produtoDAO();
...
?>
	<div class="content">
	  <div class="container">
        ...
        <input type="hidden" name="idproduto" value="<?php echo $ret[0]->idproduto;?>"><!-- imput que altera o produto  -->
			...
			<div class="mb-3">
				...
				<input type="file" class="form-control" id="imagem" name="imagem" onchange="mostrar(this)" accept="image/png, image/jpeg, image/webp">
				<div style="color:red"><?php echo $msg[5] != ""?$msg[5]:'';?></div>
			</div>
            <input type="hidden" name="img_bd" value="<?php echo $ret[0]->imagem?>">
			<br><br>
			<div class="mb-3">
               <!-- <?php// $imagem = "../produtos/{$ret[0]->imagem}";
                  //  echo $imagem;?> -->
